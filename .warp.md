...
- ✅ Production bundle created: `/Users/anthony/Sites/ableorg.ca-production/`
  - index.html, able_logo.png, re-cap_32nd_awards_gala.mp4, README.md
- ✅ Namecheap-ready (static hosting)
- ⚠️ Post-deploy actions to remember:
  - Replace placeholder emails (`info@ableorg.ca`, `tickets@ableorg.ca`)
  - Replace `#purchase` with real ticketing URLs
  - Optional: add analytics, SEO tags, and newsletter integration
